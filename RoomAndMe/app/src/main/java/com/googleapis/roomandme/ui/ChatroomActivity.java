...
import com.googleapis.roomandme.UserClient;
        ...
        View.OnClickListener
{
    ...
    private ArrayList<User1> mUserList = new ArrayList<>();
                ...
                .addSnapshotListener(new EventListener<QuerySnapshot>() {
                    ...
                    public void onEvent(@javax.annotation.Nullable QuerySnapshot queryDocumentSnapshots, @javax.annotation.Nullable FirebaseFirestoreException e) {
                        ...
                        if(queryDocumentSnapshots != null){
                            ...
                            for (QueryDocumentSnapshot doc : queryDocumentSnapshots) {
                                User1 user = doc.toObject(User1.class);
                                mUserList.add(user);
                            }
    ...
    private void initChatroomRecyclerView(){
        mChatMessageRecyclerAdapter = new ChatMessageRecyclerAdapter(mMessages, new ArrayList<User1>(), this);
    ...
    private void insertNewMessage(){
        ...
        if(!message.equals("")){
            ...
            User1 user = ((UserClient)(getApplicationContext())).getUser();
