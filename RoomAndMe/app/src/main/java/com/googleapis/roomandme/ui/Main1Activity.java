package com.googleapis.roomandme.ui;
...
import com.googleapis.roomandme.adapters.ChatroomRecyclerAdapter;
import com.googleapis.roomandme.models.Chatroom;
import com.googleapis.roomandme.adapters.ChatMessageRecyclerAdapter;
...
public class Main1Activity extends AppCompatActivity implements
    ...
    private ChatMessageRecyclerAdapter mChatroomRecyclerAdapter;
    ...
    private void initChatroomRecyclerView(){
        mChatroomRecyclerView.setAdapter(new ChatroomRecyclerAdapter(mChatrooms, this));
    ...
    private void navChatroomActivity(Chatroom chatroom){
        Intent intent = new Intent(Main1Activity.this, ChatroomActivity.class);
        ...
        builder.setPositiveButton("CREATE", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if(!input.getText().toString().equals("")){
                    ...
                    Toast.makeText(Main1Activity.this, "Enter a chatroom name", Toast.LENGTH_SHORT).show();
                }
            }
        });
